  ...
  return (
      <Dialog fullWidth maxWidth="lg" open={open} onClose={handleClose} TransitionComponent={TransitionEffect}>
        ...
        <form className={classes.content}>
          <TextField id="projectName" label="Issue Name" variant="outlined"  fullWidth required inputProps={{maxLength : 100}} 
          ...
          <TextField id="descriptions" label="Summary" variant="outlined"  fullWidth required multiline rows={15}  
